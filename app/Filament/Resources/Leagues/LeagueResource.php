...
use App\Filament\Resources\Leagues\RelationManagers\LeagueMembersRelationManager;
...
class LeagueResource extends Resource
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Leagues';
    ...
    {
        return [
            LeagueMembersRelationManager::class,
        ];
    }
